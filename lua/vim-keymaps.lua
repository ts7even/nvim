...
vim.keymap.set('n', '<leader>ql', vim.diagnostic.open_float, { noremap = true, silent = true })

-- Optionally, you can set up a keybinding to show the list of all diagnostics (e.g., in the quickfix list)
vim.keymap.set('n', '<leader>qf', vim.diagnostic.setqflist, { noremap = true, silent = true })
